...
- Record specification ownership and status separately. (CORE.PRINCIPLES.DOCUMENTS.001, CORE.PRINCIPLES.DOCUMENTS.003)
...
### Declare specification ownership (CORE.PRINCIPLES.DOCUMENTS.001)
...
### Classify specification authority (CORE.PRINCIPLES.DOCUMENTS.002)
...
### Separate authority from implementation (CORE.PRINCIPLES.DOCUMENTS.003)
...
### Retire public behavior deliberately (CORE.PRINCIPLES.DOCUMENTS.004)
...
| CORE.PRINCIPLES.DOCUMENTS.001 | static | `CoreDocumentsTests` asserts consumer validator validates required metadata fields for each specification kind. |
| CORE.PRINCIPLES.DOCUMENTS.002 | static | `CoreDocumentsTests` asserts metadata validator accepts only declared authority-status values. |
| CORE.PRINCIPLES.DOCUMENTS.003 | static | `node tools/validate-consumer.mjs` resolves both status fields against the metadata schema. |
| CORE.PRINCIPLES.DOCUMENTS.004 | inspection | Retirement review identifies removed public entry points. |
