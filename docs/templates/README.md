...
|:---|:---|:---|
| `docs/` | Domain and UI markdown templates, example docs, `domain-agent-index.json`, `project-agents.md` | Copy and fill in project `docs/domain/`, `docs/ui/`, and root `AGENTS.md` |
