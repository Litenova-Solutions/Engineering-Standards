...
- [Frontend UI governance upgrade](guides/upgrade-ui-governance.md) records a primary UI system, approved primitive boundary, token contract, and enforcement checks for `UI.GOVERNANCE.001`.
