...
This file will contain the state management and form handling conventions for all frontend projects once the frontend stack is standardized. It covers local component state, URL-based state, and form patterns using React and Next.js 15.
...
- **Form Design Pattern:** The approved pattern for forms: controlled vs. uncontrolled, schema validation library (Zod), field error display, and submission state management.
