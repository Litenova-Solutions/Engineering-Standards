...
For EF Core-owned aggregate paths, this extension replaces `WORKSPACE.DEPENDENCIES.APPLICATION.001`, `BACKEND.ARCHITECTURE.CQRS.001`, `BACKEND.PERSISTENCE.WRITE.001`, `BACKEND.PERSISTENCE.READ.001`, `BACKEND.PERSISTENCE.COMMIT.001`, `BACKEND.PERSISTENCE.EVENT.001`, `BACKEND.PERSISTENCE.MAPPING.001`, `BACKEND.PERSISTENCE.SERIALIZATION.001`, `BACKEND.PERSISTENCE.EVOLUTION.001`, and `BACKEND.PERSISTENCE.GROWTH.001`.
