...
- [ ] Page composition docs updated when routes, shell, or page composition changed (`docs/ui/{app}/shell.md`, `docs/ui/{app}/pages/*.md`, `docs/ui/{app}/README.md` route index).
