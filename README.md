...
Standards v2.0.0 targets one bounded-context business application. The `dotnet-nextjs` profile uses ASP.NET Core, PostgreSQL, Marten, and zero or more Next.js frontends. The `dotnet-blazor` profile replaces the frontend with a .NET WebAssembly client.
