...
- **No external libraries in Application.Reactions.** Event handlers define narrow interfaces for external capabilities. Infrastructure implements those interfaces.
