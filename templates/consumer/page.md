...
Create `__PAGE__.ui.json` beside this document from `ui-page.json`. Use the frontend vocabulary to select the profile, shell, patterns, components, and states. The sidecar defines:
...
List component, route, keyboard, focus, accessibility, responsive, visual, and Playwright checks. Name the evidence IDs in the UI sidecar.