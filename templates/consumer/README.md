...
| `language.json` | `docs/language.json` | Closes the vocabulary prose is checked against: terms, rejected synonyms, each rejection's scope, the compounds it excludes, and the mannered terms. |
